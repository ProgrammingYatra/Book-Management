...
function GetBooks() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:8000/books`, { headers: { Authorization: token } })
      .then((res) => {
              ...
              (
                ...
                return (
                  <div className="books shadow p-3 mb-5 bg-white rounded">
                    <img width="50%" src={bookCover} alt="book" />
                    <br />
                    <div className="">
                      <h3>
                        <a href={url}>{title}</a>
                      ...
                      <div className="btns">
                        <a className="btn btn-secondary m-2" href={createRevi}>
                          Send reviews
                        </a>
                        <a className="btn btn-dark m-2" href={deleteUrl}>
                          Delete
                        </a>
                        <a className="btn btn-outline-info" href={editurl}>
                          Edit{" "}
                        </a>
                      </div>
                    </div>
